...
如果需要模型预训练数据可以将我训练的[权重数据](https://share.weiyun.com/5lGifzi)解压，如果下载过慢可以尝试[这个网址](https://www.jianguoyun.com/p/DYz_5HkQ9_yeBxilsYwB),将里面的ckpt等文件放置到./model下。<br><br>
### 代码介绍
data放置VOC数据和数据处理生成的record文件和分化数据的txt文件<br><br>
